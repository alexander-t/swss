...
namespace AI
{
    public class AttackingBehaviorOld : Behavior
    {
        ...
        public AttackingBehaviorOld(GameObject managedShip, Transform rightGunTransform, Transform leftGunTransform, GameObject target)
        {
